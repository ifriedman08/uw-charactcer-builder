                    ...
                    <div className="modal-dialog" role="document">
                        <div className="modal-content">
                            ...
                            <div className="modal-body">
                                ...
                                <br/>
                                <br/>
                                <strong><u>The Net</u></strong> - The internet has evolved into an underground network of black-market trade, theft and laundering. There are no "businesses" or "companies" anymore. The Commonwealth has taken control of most industries but "the Net" handles everything else, especially the most valuable commodity these days: information and data. Consisting mostly of space-pirates, hackers and extortionists, the Net is where you go to get what the Commonwealth doesn't have or doesn't want you to have. Be careful when dealing with the Net. If the Commonwealth doesn't notice you and come after you, you still risk getting strong-armed by some advanced and powerful criminals.
                                <br/>
                                <br/>
