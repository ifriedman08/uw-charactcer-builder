            ...
            <div className="col-lg-4" style={{ "display": "inline-block" }}>
                ...
                <h5 className="card-header font-weight-bold">
                    ...
                    {"\u00a0\u00a0" + _util.capitalize(skill) + "    "}
                        {(this.props.isActiveCareer || this.props.isActiveOrigin) && (this.props.selectedSkills.length !== 4 || isActive) &&
                        <span className="switch switch-sm float-right">
                            <input type="checkbox" className="switch skill-switch" id={`switch-sm-${skill}`} onClick={(x) => { this.props.toggleSkillState(skill, x.target.checked) }} />
